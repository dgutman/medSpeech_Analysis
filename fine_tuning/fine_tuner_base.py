#!/usr/bin/env python3
"""
Fine-tune Whisper Base model on Medical ASR Dataset
...
def parse_arguments():
    ...
    parser.add_argument('--model-id', type=str, default='openai/whisper-base',
                       help='Whisper model to fine-tune (default: openai/whisper-base)')
    parser.add_argument('--epochs', type=int, default=10,
                       help='Number of training epochs (default: 10)')
    parser.add_argument('--batch-size', type=int, default=24,
                       help='Batch size per GPU (default: 24 for Whisper Base)')
    parser.add_argument('--learning-rate', type=float, default=0.000015,
                       help='Learning rate (default: 0.000015 for batch size 24)')
...
def main():
    ...
    if is_main_process():
        print("Starting Whisper Base fine-tuning on Medical ASR Dataset...")
