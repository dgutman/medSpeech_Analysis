#!/usr/bin/env python3
"""
Fine-tune Whisper Medium model on Medical ASR Dataset
...
def parse_arguments():
    ...
    parser.add_argument('--model-id', type=str, default='openai/whisper-medium',
                       help='Whisper model to fine-tune (default: openai/whisper-medium)')
    parser.add_argument('--epochs', type=int, default=10,
                       help='Number of training epochs (default: 10)')
    parser.add_argument('--batch-size', type=int, default=12,
                       help='Batch size per GPU (default: 12 for Whisper Medium)')
    parser.add_argument('--learning-rate', type=float, default=0.00001,
                       help='Learning rate (default: 0.00001 for batch size 12)')
...
def main():
    ...
    if is_main_process():
        print("Starting Whisper Medium fine-tuning on Medical ASR Dataset...")
